...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE INSUMOS.pagos_polizas CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
-- Tabla pagos_polizas
CREATE TABLE INSUMOS.pagos_polizas (
    id VARCHAR2(50) PRIMARY KEY,
    id_poliza VARCHAR2(50),
    seccion VARCHAR2(50),
    endoso VARCHAR2(50),
    poliza VARCHAR2(50),
    numero_cobranza VARCHAR2(50),
    prima_neta NUMBER,
    iva NUMBER,
    importe NUMBER,
    remesa VARCHAR2(50),
