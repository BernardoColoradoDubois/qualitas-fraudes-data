...
CREATE OR REPLACE TABLE `qlts-dev-mx-au-bro-verificacio.STG_PREVENCION_FRAUDES.QUERY_FOR_TLP` AS
SELECT *,
    -- PIEZAENTREGADA
...
FROM `qlts-dev-mx-au-bro-verificacio.STG_PREVENCION_FRAUDES.UNION_01`;
