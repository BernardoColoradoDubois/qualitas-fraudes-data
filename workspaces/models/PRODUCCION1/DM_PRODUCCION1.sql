...
SELECT 
  ...
  -- 10. CP
  SAFE_CAST(SAFE_CAST(NULLIF(CP, '') AS FLOAT64) AS INT64) AS CP,
  ...
  -- 65. PN_COASEG
  SAFE_CAST(SAFE_CAST(NULLIF(PN_COASEG, '') AS FLOAT64) AS INT64) AS PN_COASEG,
  
  -- 66. RECARGO_COASEG
  SAFE_CAST(SAFE_CAST(NULLIF(RECARGO_COASEG, '') AS FLOAT64) AS INT64) AS RECARGO_COASEG,
  
  -- 67. DER_COASEG
  SAFE_CAST(SAFE_CAST(NULLIF(DER_COASEG, '') AS FLOAT64) AS INT64) AS DER_COASEG,
  
  -- 68. IMPUESTO_COASEG
  SAFE_CAST(SAFE_CAST(NULLIF(IMPUESTO_COASEG, '') AS FLOAT64) AS INT64) AS IMPUESTO_COASEG,
  
  -- 69. PT_COASEG
  SAFE_CAST(SAFE_CAST(NULLIF(PT_COASEG, '') AS FLOAT64) AS INT64) AS PT_COASEG,
...
FROM `qlts-dev-mx-au-bro-verificacio.LAN_VERIFICACIONES.PRODUCCION1`;