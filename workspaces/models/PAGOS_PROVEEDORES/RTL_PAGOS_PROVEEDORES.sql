...
SELECT 
  PP.SINIESTRO||PP.CVE_BENEF||PPS.Codigo_de_Pago||PP.NRO_OP||CAST(FLOOR(RAND() * 90000000) + 10000000 AS STRING) AS ID 
  ...
  , PPS.Codigo_de_Pago AS CODIGO_PAGO
  , PP.COD_GASTO AS CODIGO_GASTO
  , PPS.Tipo_Gasto AS TIPO_GASTO
  ...
  , PP.FACTURA
  , PP.USU_FILTRO AS ID_USUARIO_FILTRO
  , PP.USU_TECNICO AS ID_USUARIO_TECNICO
  , PP.USU_PAGO AS ID_USUARIO_PAGO
  , PP.USU_RESERVA AS ID_USUARIO_RESERVA
