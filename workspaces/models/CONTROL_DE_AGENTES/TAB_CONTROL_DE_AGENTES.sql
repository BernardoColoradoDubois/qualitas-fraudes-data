CREATE OR REPLACE TABLE `{{task.params.DEST_PROJECT_ID}}.{{task.params.DEST_DATASET_NAME}}.{{task.params.DEST_TABLE_NAME}}` AS
  ...
  SAFE_CAST(NULLIF(PMA_DEV_ACUM_MES_ANIO_ANT,'') AS FLOAT64) AS PMA_DEV_ACUM_MES_ANIO_ANT,
  ...
  SAFE_CAST(NULLIF(PMA_DEV_ACUM_A_DIC_ANIO_ANT, '') AS FLOAT64) AS PMA_DEV_ACUM_A_DIC_ANIO_ANT,
  ...
  SAFE_CAST(NULLIF(PMA_PAG_NETA_A_DIC_ANIO_MENOS2,'') AS FLOAT64) AS PMA_PAG_NETA_A_DIC_ANIO_MENOS2,
  
  -- 96. PMA_DEV_ACUM_A_DIC_ANIO_MENOS2
  SAFE_CAST(NULLIF(PMA_DEV_ACUM_A_DIC_ANIO_MENOS2,'') AS FLOAT64) AS PMA_DEV_ACUM_A_DIC_ANIO_MENOS2,
