...
SELECT
  ...
  SAFE_CAST(CONCAT(SUBSTRING(FEC_PROCESO,7,4),'-',SUBSTRING(FEC_PROCESO,4,2),'-',SUBSTRING(FEC_PROCESO,1,2),' ','00:00:00') AS DATETIME) AS FEC_PROCESO,
  ...
  CURRENT_DATETIME('UTC-6') AS FECHA_CARGA
