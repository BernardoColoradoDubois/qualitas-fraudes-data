...
SELECT 
  ...
  ,SUBRAMO_DESCUENTO
  ,POLIZA_A_MSI
  ,CAST(CONCAT(SUBSTRING(FEC_CREACION_ENDO_X_CFP,7,4),'-',SUBSTRING(FEC_CREACION_ENDO_X_CFP,4,2),'-',SUBSTRING(FEC_CREACION_ENDO_X_CFP,1,2)) AS TIMESTAMP) AS FEC_CREACION_ENDO_X_CFP
