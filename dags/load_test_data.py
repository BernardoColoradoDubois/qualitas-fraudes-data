...
t2 = PythonOperator(
  ...
  op_kwargs={
    ...
    'dataset_id': 'sample_landing_siniestros',
    'table_id': 'analistas',
    'schema_fields': json.loads(get_bucket_file_contents(path='gs://us-central1-ccompquafrau-38b343aa-bucket/workspaces/json/siniestros.analistas.json')),
