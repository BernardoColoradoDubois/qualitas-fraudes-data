...
DATA_PROJECT_ID = VERIFICACIONES_CONFIG_VARIABLES_QA['DATA_PROJECT_ID']
DATA_PROJECT_REGION = VERIFICACIONES_CONFIG_VARIABLES_QA['DATA_PROJECT_REGION']
DATA_DATAFUSION_INSTANCE_NAME = VERIFICACIONES_CONFIG_VARIABLES_QA['DATA_DATAFUSION_INSTANCE_NAME']
DATA_DATAFUSION_TEMPORARY_BUCKET_NAME =  VERIFICACIONES_CONFIG_VARIABLES_QA['DATA_DATAFUSION_TEMPORARY_BUCKET_NAME']
DATA_DATAFUSION_NAMESPACE = VERIFICACIONES_CONFIG_VARIABLES_QA['DATA_DATAFUSION_NAMESPACE']
DATA_DATAPROC_CLUSTER_NAME = VERIFICACIONES_CONFIG_VARIABLES_QA['DATA_DATAPROC_CLUSTER_NAME']
DATA_DATAPROC_PROFILE_NAME = VERIFICACIONES_CONFIG_VARIABLES_QA['DATA_DATAPROC_PROFILE_NAME']
DATA_COMPOSER_WORKSPACE_BUCKET_NAME = VERIFICACIONES_CONFIG_VARIABLES_QA['DATA_COMPOSER_WORKSPACE_BUCKET_NAME']
...
APP_ORACLE_SERVICE_NAME = VERIFICACIONES_CONFIG_VARIABLES_QA['APP_ORACLE_SERVICE_NAME']
APP_ORACLE_USER = VERIFICACIONES_CONFIG_VARIABLES_QA['APP_ORACLE_USER']
APP_ORACLE_PASSWORD = VERIFICACIONES_CONFIG_VARIABLES_QA['APP_ORACLE_PASSWORD']
APP_ORACLE_INJECT_SCHEMA_NAME = VERIFICACIONES_CONFIG_VARIABLES_QA['APP_ORACLE_INJECT_SCHEMA_NAME']
APP_ORACLE_INSUMOS_SCHEMA_NAME = VERIFICACIONES_CONFIG_VARIABLES_QA['APP_ORACLE_INSUMOS_SCHEMA_NAME']
...
dag = DAG(
  'qualitas_verificaciones_data_pipeline_qa',
...
def landing_valuaciones():
  ...
  load_administradorrefacciones = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='load_administradorrefacciones',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
...
def injection():
  inject_dm_asegurados = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_asegurados_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_coberturas_movimientos = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_coberturas_movimientos_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_estados = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_estados_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_pagos_proveedores = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_pagos_proveedores_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_proveedores = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_proveedores_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_tipos_proveedores = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_tipos_proveedores_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_causas = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_causas_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_etiqueta_siniestro = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_etiqueta_siniestro_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_registro = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_registro_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_dua = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_dua_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_oficinas = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_oficinas_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_polizas_vigentes = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_polizas_vigentes_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_pagos_polizas = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_pagos_polizas_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_incisos_polizas = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_incisos_polizas_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_valuaciones = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_valuaciones_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_datos_generales = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_datos_generales_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_agentes = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_agentes_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_gerentes = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_gerentes_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_apercab = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_apercab_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_siniestros = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_siniestros_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_datos_vehiculo = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_datos_vehiculo_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
  ...
  inject_dm_coberturas = CloudDataFusionStartPipelineOperator(
    ...
    instance_name=DATA_DATAFUSION_INSTANCE_NAME,
    namespace=DATA_DATAFUSION_NAMESPACE,
    pipeline_name='inject_dm_coberturas_qa',
    project_id=DATA_PROJECT_ID,
    pipeline_type = DataFusionPipelineType.BATCH,
    success_states=["COMPLETED"],
    asynchronous=False,
