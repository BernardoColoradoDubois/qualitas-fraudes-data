...
VERIFICACIONES_CONFIG_VARIABLES = Variable.get("VERIFICACIONES_CONFIG_VARIABLES_QA", deserialize_json=True)
...
dag = DAG(
  ...
  schedule_interval=VERIFICACIONES_DATA_PIPELINE_SCHEDULE_INTERVAL,
  max_active_runs=1,
  catchup=False,
