...
query = "SELECT * FROM `qualitasfraude.DM_FRAUDES.DM_SINIESTROS` ORDER BY ID;"
...
cursor.execute('TRUNCATE TABLE INSUMOS.DM_SINIESTROS')
sql="INSERT INTO INSUMOS.DM_SINIESTROS"+" VALUES("+",".join([f":{i+1}" for i in range(df.shape[1])])+")"
