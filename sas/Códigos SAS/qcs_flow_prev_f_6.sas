/* -------------------------------------------------------
	    QUALITAS COMPAÑIA DE SEGUROS - AREA DE FRAUDES
          ...
          FLUJO DE PROGRAMAS SCORE GENERAL FAMILIA 6
   ------------------------------------------------------ */
...
%let path_glog=/qcs/projects/default/qcsrun/logs/prevencion/familia6/;
...
/*%obtiene_periodo(fecha_especifica=30/06/2022, intervalo_mes=12, num_meses_hist=12);  */
