/* -------------------------------------------------------
	    QUALITAS COMPAÑIA DE SEGUROS - AREA DE FRAUDES
           ...
           FLUJO DE PROGRAMAS SAS DE LA REGLA 2.1
   ------------------------------------------------------ */
...
%let path_glog=/qcs/projects/default/qcsrun/logs/prevencion/familia2/;
...
/*Se toma 12 meses de história (intervalo_mes) y se guarda 12 meses de história (num_meses_hist) en la tabla del score */
/*%obtiene_periodo(fecha_especifica=, intervalo_mes=12, num_meses_hist=12);  */
/*formato especificado dd/mm/YYYY*/
/*%obtiene_periodo(fecha_especifica=01/04/2022, intervalo_mes=12, num_meses_hist=12); */
