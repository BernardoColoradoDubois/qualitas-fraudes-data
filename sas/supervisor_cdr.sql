...
FROM `LAN_VERIFICACIONES.DATOSGENERALES` t1
LEFT JOIN `LAN_VERIFICACIONES.VALUADOR` t2 
    ON t1.CODVALUADOR = t2.CODVALUADOR
LEFT JOIN `LAN_VERIFICACIONES.FECHAS` t7 
    ON CAST(t1.IDEXPEDIENTE AS STRING) = t7.IDEXPEDIENTE
LEFT JOIN `LAN_VERIFICACIONES.ESTATUS` t4 
    ON CAST(t1.IDEXPEDIENTE AS STRING) = t4.IDEXPEDIENTE
LEFT JOIN `LAN_VERIFICACIONES.ESTATUSEXPEDIENTES` t5 
...
LEFT JOIN `LAN_VERIFICACIONES.VALUACION` t8 
...
LEFT JOIN `LAN_VERIFICACIONES.EXPEDIENTE` t26 
