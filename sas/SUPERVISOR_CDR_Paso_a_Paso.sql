...
PROC SQL;
   ...
   SELECT DISTINCT t1.idExp, 
          ...
          t1.CODVALUADOR, 
          /* CatValuador */
            (CASE WHEN t1.CODVALUADOR=t10.Clave THEN t10.'Categoria Actual'n ELSE t1.CatValuador END) AS CatValuador, 
          t1.HerramientaValuacion, 
          t1.EstatusValuacion, 
          t1.TipoValuador, 
          t1.Bandeja, 
          ...
          t1.EstadoCDR, 
          /* Zona */
            (IFC(t7.EntidadFederativa=t1.EstadoCDR AND t1.Pob_Comer=t7.'PoblaciónComercial'n,IFC(t7.
            'Zonas Metropolitanas'n NOT IS MISSING,t7.'Zonas Metropolitanas'n,''),'POR CLASIFICAR')) LABEL="Zona" AS 
            Zona, 
          t1.Pob_Comer, 
          t1.CLAVESUPERVISOR, 
          t1.NOMBRENNALISTA, 
          ...
          t1.SinSiniestro, 
          /* Valuacion Estadistica */
            (case
            when t8.'Valuacion Estadistica'n is missing then 0
            else t8.'Valuacion Estadistica'n
            end) AS 'Valuacion Estadistica'n, 
          /* TIPO_VE */
            (case
      ...
      FROM WORK.DG_SUPER_SERVICIO t1
           ...
           LEFT JOIN CONVENB.POBLACIONES t7 ON (t1.EstadoCDR = t7.EntidadFederativa AND (t1.Pob_Comer = t7.
          'PoblaciónComercial'n))
           LEFT JOIN CONVENB.VALUADOR_EP t10 ON (t1.CODVALUADOR = t10.Clave)
           LEFT JOIN CONVENB.VALUACION_ESTADISTICA t8 ON (t1.idExp = t8.IDEXPEDIENTE)
