...
query = "SELECT * FROM `qualitasfraude.DM_FRAUDES.DM_PROVEEDORES` ORDER BY ID;"
...
sql="INSERT INTO INSUMOS.DM_PROVEEDORES"+" VALUES("+",".join([f":{i+1}" for i in range(df.shape[1])])+")"
