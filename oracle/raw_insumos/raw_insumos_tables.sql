...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE RAW_INSUMOS.STG_ASEGURADOS CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE RAW_INSUMOS.STG_ASEGURADOS (
    ID VARCHAR2(4000),
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE RAW_INSUMOS.STG_DUA CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE RAW_INSUMOS.STG_DUA (
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE RAW_INSUMOS.STG_ETIQUETA_SINIESTRO CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE RAW_INSUMOS.STG_ETIQUETA_SINIESTRO (
    ID VARCHAR2(50),
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE RAW_INSUMOS.STG_POLIZAS_VIGENTES CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE RAW_INSUMOS.STG_POLIZAS_VIGENTES (
    ID VARCHAR2(4000),
    RAMO VARCHAR2(4000),
    POLIZA VARCHAR2(4000),
    ENDOSO VARCHAR2(4000),
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE RAW_INSUMOS.STG_PROVEEDORES CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE RAW_INSUMOS.STG_PROVEEDORES (
    ID VARCHAR2(50),
    NOMBRE VARCHAR2(255),
    MARCA VARCHAR2(100),
    TIPO VARCHAR2(100),
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE RAW_INSUMOS.STG_REGISTRO CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE RAW_INSUMOS.STG_REGISTRO (
    ID_SINIESTRO VARCHAR2(4000),
    ID_OFICINA VARCHAR2(4000),
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE RAW_INSUMOS.STG_VALUACIONES CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE RAW_INSUMOS.STG_VALUACIONES (
