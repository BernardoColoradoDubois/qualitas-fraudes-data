BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_AGENTES CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_AGENTES (
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_ANALISTA_CDR CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_ANALISTA_CDR
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_ANALISTAS CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_ANALISTAS (
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_APERCAB CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_APERCAB (
    REPORTE VARCHAR2(4000) PRIMARY KEY,
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_ASEGURADOS CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_ASEGURADOS (
    ID VARCHAR2(4000) PRIMARY KEY,
    NOMBRE VARCHAR2(4000),
    GIRO VARCHAR2(4000),
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_CAUSA_CAMBIO_VALE CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_CAUSA_CAMBIO_VALE
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_CAUSAS CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
-- Tabla DM_CAUSAS
CREATE TABLE SASVERFAP.DM_CAUSAS (
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_CERCO CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_CERCO
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_COBERTURAS_MOVIMIENTOS CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_COBERTURAS_MOVIMIENTOS (
    ID VARCHAR2(4000) PRIMARY KEY,
    RAMO VARCHAR2(4000),
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_COLOR CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_COLOR
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_COMPLEMENTO CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_COMPLEMENTO
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_DATOS_GENERALES CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_DATOS_GENERALES (
    ID VARCHAR2(4000) PRIMARY KEY,
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_DATOS_VEHICULO CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_DATOS_VEHICULO
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_DUA CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_DUA (
    DU_NUM_REPORTE VARCHAR2(4000) PRIMARY KEY,
    PROCESO NUMBER(19),
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_ENVIO_HISTORICO CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_ENVIO_HISTORICO
(
    IDENVIOHISTORICO            VARCHAR2(4000) PRIMARY KEY,
    IDEXPEDIENTE                VARCHAR2(4000),
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_ESTADO CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_ESTADO
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_ESTADOS CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_ESTADOS (
    ID VARCHAR2(4000) PRIMARY KEY,
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_ESTATUS_EXPEDIENTES CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_ESTATUS_EXPEDIENTES
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_ESTATUS CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_ESTATUS
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_ETIQUETA_SINIESTRO CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_ETIQUETA_SINIESTRO (
    ID VARCHAR2(50) PRIMARY KEY,
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_FECHAS CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_FECHAS
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_GERENTES CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_GERENTES (
  CODIGO_OFICINA VARCHAR2(16),
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_HISTORICO_TERMINO_ENTREGA CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_HISTORICO_TERMINO_ENTREGA
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_INCISOS_POLIZAS CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_INCISOS_POLIZAS (
    ID VARCHAR2(4000) PRIMARY KEY,
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_MARCA CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_MARCA
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_OFICINAS CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
-- Tabla DM_OFICINAS
CREATE TABLE SASVERFAP.DM_OFICINAS (
    ID VARCHAR2(50) PRIMARY KEY,
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_PAGOS_POLIZAS CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_PAGOS_POLIZAS (
    ID VARCHAR2(50) PRIMARY KEY,
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_PAGOS_PROVEEDORES CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_PAGOS_PROVEEDORES (
    ID VARCHAR2(4000) PRIMARY KEY,
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_POLIZAS_VIGENTES CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_POLIZAS_VIGENTES (
    ID VARCHAR2(4000) PRIMARY KEY,
    RAMO VARCHAR2(4000),
    POLIZA VARCHAR2(4000),
    ENDOSO VARCHAR2(4000),
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_PROVEEDOR CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_PROVEEDOR
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_PROVEEDORES CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_PROVEEDORES (
    ID VARCHAR2(50) PRIMARY KEY,
    NOMBRE VARCHAR2(255),
    MARCA VARCHAR2(100),
    TIPO VARCHAR2(100),
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_REFACCION CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_REFACCION
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_REGISTRO CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_REGISTRO (
    ID_SINIESTRO VARCHAR2(4000) PRIMARY KEY,
    ID_OFICINA VARCHAR2(4000),
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_SINIESTROS CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_SINIESTROS (
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_SUPERVISOR_INTEGRAL CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_SUPERVISOR_INTEGRAL
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_TALLERES CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_TALLERES
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_TIPOS_PROVEEDORES CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_TIPOS_PROVEEDORES (
    ID VARCHAR2(4000) PRIMARY KEY,
    TIPO_PROVEEDOR VARCHAR2(4000),
    GRUPO VARCHAR2(4000),
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_VALE_HISTORICO CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_VALE_HISTORICO
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_VALE CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_VALE
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_VALUACION CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_VALUACION
(
    IDVALUACION             VARCHAR2(4000) NOT NULL PRIMARY KEY,
    DESCRIPCION             VARCHAR2(4000),
    ALTA                    DATE,
    ACTUALIZACION           DATE,
    USUARIOACTUALIZA        VARCHAR2(4000)
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_VALUACIONES CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE SASVERFAP.DM_VALUACIONES (
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE SASVERFAP.DM_COBERTURAS CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
-- Tabla DM_CAUSAS
CREATE TABLE SASVERFAP.DM_COBERTURAS (
    ID VARCHAR2(50) PRIMARY KEY,
