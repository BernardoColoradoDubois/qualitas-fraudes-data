...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE INSUMOS.DM_APERCAB CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE INSUMOS.DM_APERCAB (
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE INSUMOS.DM_DATOS_GENERALES CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE INSUMOS.DM_DATOS_GENERALES (
    ID VARCHAR2(4000) PRIMARY KEY,
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE INSUMOS.DM_ENVIO_HISTORICO CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE INSUMOS.DM_ENVIO_HISTORICO
(
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE INSUMOS.DM_VALUACION CASCADE CONSTRAINTS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
CREATE TABLE INSUMOS.DM_VALUACION
(
